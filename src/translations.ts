const TRANSLATIONS = {
	...
	"Hold NFT": "持有NFT",
	"To get 2X Boost from each partner": "从每个合作伙伴那里获得2倍加速",
	"Get NFT to double points": "获得NFT，获得2倍积分",
	...
	"You got the 4X Boost from partners NFT": "从合作伙伴的NFT获得4倍加速",
	"2x Boost Activated": "已激活2倍加速",
	"2x Boost Activated for Monad Nomads": "已激活Monad Nomads的2倍加速",
	...
	"Your deposits fuel": "你存入giga资产，即软性锚定的合成流动性资",
	gigaAssets: "giga资产，",
